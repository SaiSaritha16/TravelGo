...
app = Flask(__name__)
app.secret_key = 'e32aee82e6d2a3d1f420eb6de70cbe073d953f28d79195b75898770a8f05a0ac' # IMPORTANT: Change this to a strong, random key in production!
...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:120569613040:Travelgo:76ac239c-a527-48ed-8820-b99872226159'  # Replace with actual SNS topic ARN
